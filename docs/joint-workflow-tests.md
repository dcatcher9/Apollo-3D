...
headset. Packed chroma regressions execute the production D3D shaders through WARP's software
renderer, including transfer order and independent eye boundaries. Run it with both checkouts

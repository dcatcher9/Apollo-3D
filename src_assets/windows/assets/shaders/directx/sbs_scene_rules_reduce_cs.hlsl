...
// Four runs per axis cover the common 2x2 and 3x3 equal-tile layouts without allowing an
...
void main(uint3 dispatch_id : SV_DispatchThreadID) {
    ...
    bool adaptive_finite =
        ...
        all(isfinite(AdaptiveState[
            SBS_STATE_VECTOR_EXTERNAL_CUT_COUNT]));
    ...
    float history_depth_fraction =
        valid_cells > 0.0f ?
            saturate(depth_confidence_sum / valid_cells) :
            0.0f;

...
#define V2_CONTRACT_TAG 0x8753E5C6u
...
#define V2_SUBTITLE_LIVE_FIELD_SHAPE_COUNT 6u
...
uint V2SubtitleLocatorFieldCellScale(uint field_width, uint field_height) {
    ...
    if ((field_width == V2_SUBTITLE_LIVE_FIELD_WIDTH_0 && field_height == V2_SUBTITLE_LIVE_FIELD_HEIGHT_0) ||
           ...
           (field_width == V2_SUBTITLE_LIVE_FIELD_WIDTH_5 && field_height == V2_SUBTITLE_LIVE_FIELD_HEIGHT_5)) return 2u;
    return 0u;
}

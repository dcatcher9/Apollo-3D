...
Texture2D<uint>           TensorExclusion : register(t4);
...
void main(uint3 DTid : SV_DispatchThreadID) {
    ...
    uint2 sample_position = TensorExclusion[DTid.xy] != 0u ?
        DepthAnalysisClampCell(DTid.xy) : DTid.xy;
    ...
    float old_depth = PreviousDepth[sample_position];
    ...
    OutputTexture[DTid.xy] = EmaMotionMask[sample_position] != 0u ?

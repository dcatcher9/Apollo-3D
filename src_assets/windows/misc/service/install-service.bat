...
sc %SC_CMD% %SERVICE_NAME% binPath= "\"%SERVICE_BIN%\"" start= %SERVICE_START_TYPE% DisplayName= "Sunshine 3D Service"

rem Set the description of the service
sc description %SERVICE_NAME% "Sunshine 3D streams this PC to Moonlight 3D on Android XR headsets and AR glasses."

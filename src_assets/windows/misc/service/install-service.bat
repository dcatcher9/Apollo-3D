...
sc %SC_CMD% %SERVICE_NAME% binPath= "\"%SERVICE_BIN%\"" start= %SERVICE_START_TYPE% DisplayName= "Apollo XR Service"

rem Set the description of the service
sc description %SERVICE_NAME% "Apollo XR streams this PC to Android XR headsets and AR glasses."

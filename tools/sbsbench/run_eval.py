...
def authoritative_remeasurement_clip_meta(
    ...
    22 for production depth; unrelated to Dump 3D and the independently versioned DVC2 contract),
    ...
    if direct_parallax_run:
        ...
        # this is intentionally independent of Dump 3D and the independently versioned DVC2 contract.

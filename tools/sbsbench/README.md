...
**Eval schema 3 correctness contract (2026-07-10):** `run_eval.py` pins the model explicitly. The
...
Schema 3 adds optional `gt_depth/frame_*.png` clip sidecars and includes them plus their semantic

#!/usr/bin/env python3
"""Generate non-authoritative diagnostic previews from a current-schema Dump 3D package."""
...
def main() -> int:
    ...
    parser.add_argument("dump", type=Path, help="current-schema Dump 3D directory")

...
schema-18 production harness finishes, rechecks it after scoring, and stores it in
...
EVALUATOR_SCHEMA = 36
HARNESS_CONTRACT_SCHEMA = 18
MANIFEST_SCHEMA = 1
RESULTS_META_KEY = "whole_clip_raw_artifacts"
BINDING = "schema-36-results-to-schema-18-harness-raw-f32-v1"
RAW_SHAPE_SCHEMA = 1

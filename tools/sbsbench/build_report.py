...
METRIC_DEFS = [
    ...
    ("pop_spread_px",
     "pop_spread",
     "Near-to-far horizontal disparity range in output pixels, shown for intuition. Decisions use pop_spread_pct, normalized to perceived disparity at Artemis's fixed panel height and the 5120x2160 reference aspect.",
     "higher = more stereo volume"),
    ("positive_disparity_pct",
     "disp_positive",
     "Weighted p99 of the positive signed L/R disparity tail, expressed as the equivalent percentage at the 5120x2160 Artemis reference aspect. Kept sign-explicit because crossed/uncrossed polarity is not encoded in the host image.",

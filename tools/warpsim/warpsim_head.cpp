...
static const int SW = 800, SH = 800;
static const int SOX = 1900, SOY = 100;
static const int OW = 560, OH = 560;
static const int EOX = 1620, EOY = 180;
...
static void reproject_blend(float ux, float vy, unsigned char *rgb) {
    ...
    float tv = 0.0f;  // total depth variation over the window
...
int main(int argc, char **argv) {
    ...
    if (argc > 9) g_eye_sign = (float) atof(argv[9]);
    ...
    load("depth2_1596x672.bin", g_depth, (size_t) DW * DH);
    load("source2_x1900y100_800x800.bin", g_src, (size_t) SW * SH * 3);
